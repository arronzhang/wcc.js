...
console.error(e);
  ...
  d_["./index.wxml"] = {};var m0= function(e, s, r, gg){var z = gz$gwx_1();cs.push("./index.wxml:view:1:2");var x_C = _mz(z, 'view', ["d", -1,"y", 0], [], e,s,gg,false);cs.pop();_(r, x_C);return r;};e_["./index.wxml"] = {f: m0,j: [],i: [],ti: [],ic: []};
  if(path&&e_[path]){
