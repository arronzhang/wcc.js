...
console.error(e);
  ...
  d_["./index.wxml"] = {};var m0= function(e, s, r, gg){var z = gz$gwx_1();cs.push("./index.wxml:view:1:2");var x_C = _mz(z, 'view', ["di", -1,"y", 0], [], e,s,gg,false);var x_D = _oz(z, 1, e, s, gg);_(x_C, x_D);cs.push("./index.wxml:view:2:4");var x_E = _n("view", false);var x_F = _oz(z, 2, e, s, gg);_(x_E, x_F);cs.pop();_(x_C, x_E);cs.pop();_(r, x_C);return r;};e_["./index.wxml"] = {f: m0,j: [],i: [],ti: [],ic: []};
  if(path&&e_[path]){
