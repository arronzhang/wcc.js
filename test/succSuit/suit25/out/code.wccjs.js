...
Z([3, 'index/component/component.wxml']);
...
console.error(e);
  ...
  d_["./index/component/component.wxml"] = {};var m0= function(e, s, r, gg){var z = gz$gwx_1();cs.push("./index/component/component.wxml:text:2:2");var x_C = _n("text", false);var x_D = _oz(z, 0, e, s, gg);_(x_C, x_D);cs.pop();_(r, x_C);return r;};e_["./index/component/component.wxml"] = {f: m0,j: [],i: [],ti: [],ic: []};d_["./index/index.wxml"] = {};var m1= function(e, s, r, gg){var z = gz$gwx_2();cs.push("./index/index.wxml:comp:1:2");var x_C = _n("comp", false);cs.pop();_(r, x_C);return r;};e_["./index/index.wxml"] = {f: m1,j: [],i: [],ti: [],ic: []};
  if(path&&e_[path]){
